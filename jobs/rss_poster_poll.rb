      ...
      begin
        ...
        rss.items.each do |item|
          begin
            ...
            content = HTMLEntities.new(:expanded).decode(
              item.summary.try(:force_encoding, 'UTF-8').try(:scrub).try(:gsub, regexp_body, feed.regexp_body_replacement.to_s) || # for StackOverflow.com RSS feed
